...
export default function Features() {
    ...
    return (
        <section id="features" className="py-28 scroll-mt-24 relative">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center mb-20">
                    ...
                    >
                        Tools designed to help you understand your body and achieve your wellness goals.
                    </motion.p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    {features.map((feature, index) => {
                        ...
                        return (
                            <motion.div
                                key={index}
                                className={`glass p-8 rounded-2xl hover:shadow-xl transition-all hover:-translate-y-1 ${feature.size}`}
